...
complete --command odand --no-files

# Extract options
function __fish_odand_get_options
...
complete \
    --command odand \
    --arguments "(__fish_odand_get_options --nofiles)"
