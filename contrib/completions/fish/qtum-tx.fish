...
# Extract options
function __fish_odan_tx_get_options
...
# Extract commands
function __fish_odan_tx_get_commands
...
complete \
    --command odan-tx \
    --condition "not __fish_odan_seen_cmd (__fish_odan_tx_get_commands --commandsonly)" \
    --arguments "(__fish_odan_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command odan-tx \
    --arguments "(__fish_odan_tx_get_commands)" \
    --no-files
