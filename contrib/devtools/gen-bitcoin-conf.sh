...
BITCOIND=${BITCOIND:-$BINDIR/odand}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/odan.conf}
...
then
  ...
  echo -e "To safely generate a odan.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example odan.conf file in share/examples/'
