# Bootstrappable Odan Core Builds

This directory contains the files necessary to perform bootstrappable Odan
Core builds.
...
To build Odan Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/odan-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/odanproject/guix.sigs).
