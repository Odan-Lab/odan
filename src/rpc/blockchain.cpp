...
UniValue blockheaderToJSON(const CBlockIndex& tip, const CBlockIndex& blockindex)
{
    ...
    result.pushKV("hashStateRoot", blockindex.hashStateRoot.GetHex()); // odan
    result.pushKV("hashUTXORoot", blockindex.hashUTXORoot.GetHex()); // odan

    if(blockindex.IsProofOfStake()){
        result.pushKV("prevoutStakeHash", blockindex.prevoutStake.hash.GetHex()); // odan
        result.pushKV("prevoutStakeVoutN", (int64_t)blockindex.prevoutStake.n); // odan
    }
...
RPCHelpMan getdelegationinfoforaddress()
{
    return RPCHelpMan{"getdelegationinfoforaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The odan address string"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    OdanDelegation odanDelegation;
    Delegation delegation;
    PKHash pkhash = std::get<PKHash>(dest);
    uint160 address = uint160(pkhash);
    if(!odanDelegation.GetDelegation(address, delegation, chainman.ActiveChainstate())) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegation");
    }
    bool verified = odanDelegation.VerifyDelegation(address, delegation);
...
RPCHelpMan getdelegationsforstaker()
{
    return RPCHelpMan{"getdelegationsforstaker",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The odan address string for staker"},
                },
               RPCResult{
            RPCResult::Type::ARR, "", "",
                {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if(!odanDelegation.FilterDelegationEvents(events, filter, chainman)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegations for staker");
    }
    std::map<uint160, Delegation> delegations = odanDelegation.DelegationsFromEvents(events);
        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "", {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Odan address (only if a well-defined address exists)"},
                }},
...
static RPCHelpMan oasFname()
{
    return RPCHelpMan{"oasFname",
                ...
                RPCExamples{
                    HelpExampleCli("oasFname", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("oasFname", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan oasFsymbol()
{
    return RPCHelpMan{"oasFsymbol",
                ...
                RPCExamples{
                    HelpExampleCli("oasFsymbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("oasFsymbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan oasFtotalsupply()
{
    return RPCHelpMan{"oasFtotalsupply",
                ...
                RPCExamples{
                    HelpExampleCli("oasFtotalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("oasFtotalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan oasFdecimals()
{
    return RPCHelpMan{"oasFdecimals",
                ...
                RPCExamples{
                    HelpExampleCli("oasFdecimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("oasFdecimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan oasFbalanceof()
{
    return RPCHelpMan{"oasFbalanceof",
                "\nReturns the token balance for address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The odan address to check token balance"},
                },
                RPCResult{
                    RPCResult::Type::STR, "balance", "The token balance of the chosen address"},
                RPCExamples{
                    HelpExampleCli("oasFbalanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("oasFbalanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Get parameters
...
static RPCHelpMan oasFallowance()
{
    return RPCHelpMan{"oasFallowance",
                "\nReturns remaining tokens allowed to spend for an address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"addressfrom", RPCArg::Type::STR, RPCArg::Optional::NO,  "The odan address of the account owning tokens"},
                    {"addressto", RPCArg::Type::STR, RPCArg::Optional::NO,  "The odan address of the account able to transfer the tokens"},
                },
                RPCResult{
                    RPCResult::Type::STR, "allowance", "Amount of remaining tokens allowed to spent"},
                RPCExamples{
                    HelpExampleCli("oasFallowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
            + HelpExampleRpc("oasFallowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan oasFlisttransactions()
{
    return RPCHelpMan{"oasFlisttransactions",
                "\nReturns transactions history for a specific address.\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The odan address to get history for."},
            ...
            RPCResult::Type::ARR, "", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR, "receiver", "The receiver odan address"},
                            {RPCResult::Type::STR, "sender", "The sender odan address"},
                ...
                RPCExamples{
                    HelpExampleCli("oasFlisttransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleCli("oasFlisttransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
            + HelpExampleRpc("oasFlisttransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("oasFlisttransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Get parameters
...
void RegisterBlockchainRPCCommands(CRPCTable& t)
{
    static const CRPCCommand commands[]{
        ...
        {"blockchain", &oasFname},
        {"blockchain", &oasFsymbol},
        {"blockchain", &oasFtotalsupply},
        {"blockchain", &oasFdecimals},
        {"blockchain", &oasFbalanceof},
        {"blockchain", &oasFallowance},
        {"blockchain", &oasFlisttransactions},
