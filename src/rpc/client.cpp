...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "oasFlisttransactions", 2, "fromblock"},
    { "oasFlisttransactions", 3, "minconf"},
    //////////////////////////////////////////////////
    ...
    { "oasFapprove", 4, "gaslimit" },
    { "oasFapprove", 5, "gasprice" },
    { "oasFapprove", 6, "checkoutputs" },
    { "oasFtransfer", 4, "gaslimit" },
    { "oasFtransfer", 5, "gasprice" },
    { "oasFtransfer", 6, "checkoutputs" },
    { "oasFtransferfrom", 5, "gaslimit" },
    { "oasFtransferfrom", 6, "gasprice" },
    { "oasFtransferfrom", 7, "checkoutputs" },
    { "oasFburn", 3, "gaslimit" },
    { "oasFburn", 4, "gasprice" },
    { "oasFburn", 5, "checkoutputs" },
    { "oasFburnfrom", 4, "gaslimit" },
    { "oasFburnfrom", 5, "gasprice" },
    { "oasFburnfrom", 6, "checkoutputs" },
