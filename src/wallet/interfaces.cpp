...
#include <key_io.h>
#include <odan/delegationutils.h>
...
public:
    ...
    bool isUnspentAddress(const std::string &odanAddress) override
    {
        LOCK(m_wallet->cs_wallet);
        ...
        for (const COutput& out : vecOutputs)
        {
            ...
            if(fValidAddress && EncodeDestination(address) == odanAddress && out.txout.nValue)
            {
                return true;
            }
        }
