...
struct Params {
    ...
    int nLastPOWBlock;
    uint64_t decayFactorFP;             // 1.1149 * 1e8 => 111490000
    int nFirstMPoSBlock;
    ...
    int nLastBigReward;
    CAmount initialSubsidy;             // 10 * COIN
    std::vector<CAmount> subsidyLookup; // precomputed early cycles
    CAmount highSubsidyAmount;
    ...
    {
        return nStakeTimestampMask / 2.5;
    }
