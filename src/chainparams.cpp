...
std::string CChainParams::EVMGenesisInfo() const
{
    ...
    return dev::eth::genesisInfoOdan(GetEVMNetwork(), evmConsensus);
}
...
{
    return dev::eth::Network::odanNetwork;
}
...
{
    consensus.nSubsidyHalvingInterval = 210240; // odan halving every 4 years
