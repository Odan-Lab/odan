...
#include "genesis/odanNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::odanNetwork: return c_genesisInfoOdanNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::odanNetwork: return c_genesisStateRootOdanNetwork;
    default:
        throw std::invalid_argument("Invalid network value");
    }
}
...
std::string dev::eth::genesisInfoOdan(Network _n, EVMConsensus _consensus)
{
