...
////////////////////////////////////////////////////////////// // odan
    void setOdanSchedule(EVMSchedule _odanSchedule) const { odanSchedule = _odanSchedule; }

    EVMSchedule& getOdanSchedule() const { return odanSchedule; }
...
private:
    ...
    mutable EVMSchedule odanSchedule; // odan
