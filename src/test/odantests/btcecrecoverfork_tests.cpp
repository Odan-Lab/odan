...
//    initState();
    ...
    std::vector<OdanTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createOdanTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createOdanTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createOdanTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createOdanTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
