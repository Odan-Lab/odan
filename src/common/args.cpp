...
const char * const BITCOIN_CONF_FILENAME = "odan.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Odan
    // macOS: ~/Library/Application Support/Odan
    // Unix-like: ~/.odan
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Odan";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Odan";
#else
    // Unix-like
    return pathRet / ".odan";
#endif
