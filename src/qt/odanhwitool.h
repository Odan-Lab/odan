#ifndef ODANHWITOOL_H
#define ODANHWITOOL_H
...
/**
 * @brief The OdanHwiTool class Communicate with the Odan Hardware Wallet Interface Tool
 */
class OdanHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief OdanHwiTool Constructor
     * @param parent Parent object
     */
    explicit OdanHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~OdanHwiTool Destructor
     */
    ~OdanHwiTool();
