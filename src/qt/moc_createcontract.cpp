...
QT_MOC_LITERAL(6, 55, 24), // "on_createContractClicked"
...
QT_MOC_LITERAL(11, 134, 21), // "on_updateCreateButton"
QT_MOC_LITERAL(12, 156, 17), // "on_newContractABI"
QT_MOC_LITERAL(13, 174, 17) // "updateDisplayUnit"

    },
    "CreateContract\0message\0\0title\0style\0"
    "on_clearAllClicked\0on_createContractClicked\0"
    "on_gasInfoChanged\0blockGasLimit\0"
    "minGasPrice\0nGasPrice\0on_updateCreateButton\0"
    "on_newContractABI\0updateDisplayUnit"
};
...
void CreateContract::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CreateContract *>(_o);
        (void)_t;
        switch (_id) {
        ...
        case 2: _t->on_createContractClicked(); break;
        ...
        case 4: _t->on_updateCreateButton(); break;
        ...
        {
            using _t = void (CreateContract::*)(const QString & , const QString & , unsigned int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CreateContract::message)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CreateContract::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CreateContract.data,
    qt_meta_data_CreateContract,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void CreateContract::message(const QString & _t1, const QString & _t2, unsigned int _t3)
{
