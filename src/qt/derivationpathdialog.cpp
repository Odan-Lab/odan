    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(OdanHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(OdanHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(OdanHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(OdanHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(OdanHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(OdanHwiTool::derivationPathBech32());
