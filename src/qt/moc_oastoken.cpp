/****************************************************************************
** Meta object code from reading C++ file 'oastoken.h'
**
...
#error "The header file 'oastoken.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_OASToken_t {
    QByteArrayData data[31];
    char stringdata0[386];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OASToken_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OASToken_t qt_meta_stringdata_OASToken = {
    {
QT_MOC_LITERAL(0, 0, 8), // "OASToken"
...
QT_MOC_LITERAL(30, 374, 11) // "on_addToken"
    ...
    "OASToken\0message\0\0title\0style\0"
...
static const uint qt_meta_data_OASToken[] = {
...
void OASToken::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OASToken *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (OASToken::*)(const QString & , const QString & , unsigned int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OASToken::message)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OASToken::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_OASToken.data,
    qt_meta_data_OASToken,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *OASToken::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *OASToken::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_OASToken.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int OASToken::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void OASToken::message(const QString & _t1, const QString & _t2, unsigned int _t3)
{
