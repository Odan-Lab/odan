...
QT_MOC_LITERAL(3, 33, 11), // "BitcoinUnit"
QT_MOC_LITERAL(4, 45, 4), // "unit"
QT_MOC_LITERAL(5, 50, 26), // "coinControlFeaturesChanged"
QT_MOC_LITERAL(6, 77, 19), // "showTrayIconChanged"
QT_MOC_LITERAL(7, 97, 19), // "fontForMoneyChanged"
QT_MOC_LITERAL(8, 117, 30) // "zeroBalanceAddressTokenChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0"
    "BitcoinUnit\0unit\0coinControlFeaturesChanged\0"
    "showTrayIconChanged\0fontForMoneyChanged\0"
    "zeroBalanceAddressTokenChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->displayUnitChanged((*reinterpret_cast< BitcoinUnit(*)>(_a[1]))); break;
        ...
        case 3: _t->fontForMoneyChanged((*reinterpret_cast< const QFont(*)>(_a[1]))); break;
        case 4: _t->zeroBalanceAddressTokenChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OptionsModel::*)(BitcoinUnit );
        ...
        {
            using _t = void (OptionsModel::*)(const QFont & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::fontForMoneyChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (OptionsModel::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::zeroBalanceAddressTokenChanged)) {
                *result = 4;
                return;
            }
        }
