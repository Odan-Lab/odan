#ifndef ODANVERSIONCHECKER_H
#define ODANVERSIONCHECKER_H

#include <QObject>

#define ODAN_RELEASES "https://github.com/Odan-Lab/odan/releases"
...
class OdanVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit OdanVersionChecker(QObject *parent = 0);
    ~OdanVersionChecker();
