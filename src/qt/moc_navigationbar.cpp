...
QT_MOC_LITERAL(1, 14, 7), // "resized"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 13), // "onSubBarClick"
QT_MOC_LITERAL(4, 37, 18), // "setToolButtonStyle"
QT_MOC_LITERAL(5, 56, 19), // "Qt::ToolButtonStyle"
QT_MOC_LITERAL(6, 76, 15) // "toolButtonStyle"

    },
    "NavigationBar\0resized\0\0onSubBarClick\0"
...
void NavigationBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onSubBarClick((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            using _t = void (NavigationBar::*)(const QSize & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NavigationBar::resized)) {
                *result = 0;
                return;
            }
        }
