...
static const QColor LINK_COLOR = "#2dd050ff";

class OdanStyle : public QProxyStyle
{
public:
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    OdanStyle* odanStyle = new OdanStyle;
    odanStyle->setBaseStyle(mainStyle);
    app->setStyle(odanStyle);
