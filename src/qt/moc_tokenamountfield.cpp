...
void TokenAmountField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TokenAmountField *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (TokenAmountField::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TokenAmountField::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TokenAmountField::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_TokenAmountField.data,
    qt_meta_data_TokenAmountField,
    qt_static_metacall,
    nullptr,
    nullptr
} };
