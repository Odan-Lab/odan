...
{
    switch (unit) {
    case Unit::BTC: return QString("ODAN");
    case Unit::mBTC: return QString("mODAN");
    case Unit::uBTC: return QString::fromUtf8("µODAN (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Odans");
    case Unit::mBTC: return QString("Milli-Odans (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Odans (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
