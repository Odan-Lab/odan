...
QT_MOC_LITERAL(4, 56, 27), // "on_updateCallContractButton"
QT_MOC_LITERAL(5, 84, 17), // "on_newContractABI"
QT_MOC_LITERAL(6, 102, 18), // "on_saveInfoClicked"
QT_MOC_LITERAL(7, 121, 18), // "on_loadInfoClicked"
QT_MOC_LITERAL(8, 140, 22), // "on_pasteAddressClicked"
QT_MOC_LITERAL(9, 163, 25) // "on_contractAddressChanged"

    },
    "CallContract\0on_clearAllClicked\0\0"
    "on_callContractClicked\0"
...
void CallContract::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CallContract *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->on_clearAllClicked(); break;
        case 1: _t->on_callContractClicked(); break;
        case 2: _t->on_updateCallContractButton(); break;
        case 3: _t->on_newContractABI(); break;
        case 4: _t->on_saveInfoClicked(); break;
        case 5: _t->on_loadInfoClicked(); break;
        case 6: _t->on_pasteAddressClicked(); break;
        case 7: _t->on_contractAddressChanged(); break;
        default: ;
        }
    }
    (void)_a;
...
QT_INIT_METAOBJECT const QMetaObject CallContract::staticMetaObject = { {
    ...
    qt_meta_stringdata_CallContract.data,
    qt_meta_data_CallContract,
    qt_static_metacall,
    nullptr,
    nullptr
} };
