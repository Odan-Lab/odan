...
struct qt_meta_stringdata_OptionTests_t {
    QByteArrayData data[7];
    char stringdata0[87];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OptionTests_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OptionTests_t qt_meta_stringdata_OptionTests = {
    {
QT_MOC_LITERAL(0, 0, 11), // "OptionTests"
QT_MOC_LITERAL(1, 12, 4), // "init"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 15), // "migrateSettings"
QT_MOC_LITERAL(4, 34, 16), // "integerGetArgBug"
QT_MOC_LITERAL(5, 51, 21), // "parametersInteraction"
QT_MOC_LITERAL(6, 73, 13) // "extractFilter"

    },
    "OptionTests\0init\0\0migrateSettings\0"
    "integerGetArgBug\0parametersInteraction\0"
    "extractFilter"
};
...
QT_INIT_METAOBJECT const QMetaObject OptionTests::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_OptionTests.data,
    qt_meta_data_OptionTests,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OptionTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OptionTests.stringdata0))
