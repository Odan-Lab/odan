    ...
    menuColor(0,0,0)
{
    ...
    if (colorizeIcons) {
        singleColor = GetStringStyleValue("platformstyle/single-color", "#00c81bff");
    }
    // Determine text color
    textColor = GetStringStyleValue("platformstyle/text-color", "#e6f0e6ff");
    ...
    tableColorInput = GetStringStyleValue("platformstyle/table-color-input", "#2fdf38ff");
    ...
    multiStatesIconColor3 = GetStringStyleValue("platformstyle/multi-states-icon-color3", "#5a5d5aff");
}
