...
public:
    ...
    void setupUi(QStackedWidget *ContractResult)
    {
        if (ContractResult->objectName().isEmpty())
            ContractResult->setObjectName(QString::fromUtf8("ContractResult"));
        ContractResult->resize(941, 503);
        ContractResult->setStyleSheet(QString::fromUtf8("QLineEdit{\n"
" border: 0px;\n"
"background: transparent;\n"
"}"));
        pageCreateOrSendToResult = new QWidget();
        pageCreateOrSendToResult->setObjectName(QString::fromUtf8("pageCreateOrSendToResult"));
        ...
        groupBoxCreateOrSendTo->setObjectName(QString::fromUtf8("groupBoxCreateOrSendTo"));
        ...
        lineEditTxID->setObjectName(QString::fromUtf8("lineEditTxID"));
        ...
        labelHash160->setObjectName(QString::fromUtf8("labelHash160"));
        ...
        lineEditHash160->setObjectName(QString::fromUtf8("lineEditHash160"));
        ...
        labelTxID->setObjectName(QString::fromUtf8("labelTxID"));
        ...
        pageCallResult->setObjectName(QString::fromUtf8("pageCallResult"));
        verticalLayout = new QVBoxLayout(pageCallResult);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        groupBoxCallContract = new QGroupBox(pageCallResult);
        groupBoxCallContract->setObjectName(QString::fromUtf8("groupBoxCallContract"));
        groupBoxCallContract->setStyleSheet(QString::fromUtf8(""));
        ...
        labelCallContractAddress->setObjectName(QString::fromUtf8("labelCallContractAddress"));
        ...
        lineEditCallContractAddress->setObjectName(QString::fromUtf8("lineEditCallContractAddress"));
        ...
        scrollAreaParams->setObjectName(QString::fromUtf8("scrollAreaParams"));
        ...
        scrollAreaParams->setStyleSheet(QString::fromUtf8(""));
        ...
        lineEditCallSenderAddress->setObjectName(QString::fromUtf8("lineEditCallSenderAddress"));
        ...
        labelCallSenderAddress->setObjectName(QString::fromUtf8("labelCallSenderAddress"));
        ...
        scrollAreaResult->setObjectName(QString::fromUtf8("scrollAreaResult"));
    ...
    {
        ContractResult->setWindowTitle(QCoreApplication::translate("ContractResult", "StackedWidget", nullptr));
        groupBoxCreateOrSendTo->setTitle(QCoreApplication::translate("ContractResult", "Contract Summary", nullptr));
        labelContractAddress->setText(QCoreApplication::translate("ContractResult", "ContractAddress", nullptr));
        labelHash160->setText(QCoreApplication::translate("ContractResult", "Hash160", nullptr));
        labelSenderAddress->setText(QCoreApplication::translate("ContractResult", "SenderAddress", nullptr));
        labelTxID->setText(QCoreApplication::translate("ContractResult", "Transaction ID", nullptr));
        groupBoxCallContract->setTitle(QCoreApplication::translate("ContractResult", "Contract Summary", nullptr));
        labelCallContractAddress->setText(QCoreApplication::translate("ContractResult", "ContractAddress", nullptr));
        labelFunction->setText(QCoreApplication::translate("ContractResult", "Function", nullptr));
        labelCallSenderAddress->setText(QCoreApplication::translate("ContractResult", "SenderAddress", nullptr));
        groupBoxResult->setTitle(QCoreApplication::translate("ContractResult", "Result", nullptr));
    } // retranslateUi
