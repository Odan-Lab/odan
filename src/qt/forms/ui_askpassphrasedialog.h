...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->resize(598, 264);
        ...
        formLayout->setWidget(4, QFormLayout::LabelRole, passLabel3);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, passEdit3);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, toggleShowPasswordButton);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, capsLabel);

        stakingCheckBox = new QCheckBox(AskPassphraseDialog);
        stakingCheckBox->setObjectName(QString::fromUtf8("stakingCheckBox"));

        formLayout->setWidget(8, QFormLayout::SpanningRole, stakingCheckBox);
