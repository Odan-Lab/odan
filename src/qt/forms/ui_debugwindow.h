...
public:
    ...
    OdanPushButton *openDebugLogfileButton;
    ...
    OdanPushButton *fontSmallerButton;
    OdanPushButton *fontBiggerButton;
    OdanPushButton *clearButton;
    QTextEdit *messagesWidget;
    QHBoxLayout *horizontalLayoutPrompt;
    OdanPushButton *promptIcon;
    QLineEdit *lineEdit;
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        labelGeneral = new QLabel(tab_info);
        ...
        gridLayout->addWidget(labelGeneral, 0, 0, 1, 1);
        ...
        clientUserAgent->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        dataDir->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        blocksDir->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        networkName->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        labelBlockChain = new QLabel(tab_info);
        labelBlockChain->setObjectName(QString::fromUtf8("labelBlockChain"));
        labelBlockChain->setFont(font);

        gridLayout->addWidget(labelBlockChain, 9, 0, 1, 1);
        ...
        mempoolNumberTxs->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        mempoolSize->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        openDebugLogfileButton = new OdanPushButton(tab_info);
        ...
        fontSmallerButton = new OdanPushButton(tab_console);
        ...
        fontBiggerButton = new OdanPushButton(tab_console);
        ...
        clearButton = new OdanPushButton(tab_console);
        ...
        promptIcon = new OdanPushButton(tab_console);
        ...
        lineEdit->setMaxLength(20000000);
        ...
        peerHeading->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        detailWidget->setGeometry(QRect(0, 0, 300, 432));
        ...
        peerPermissions->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        peerConnectionType->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(peerConnectionType, 1, 1, 1, 1);

        peerTransportTypeLabel = new QLabel(detailWidget);
        peerTransportTypeLabel->setObjectName(QString::fromUtf8("peerTransportTypeLabel"));

        gridLayout_2->addWidget(peerTransportTypeLabel, 2, 0, 1, 1);

        peerTransportType = new QLabel(detailWidget);
        peerTransportType->setObjectName(QString::fromUtf8("peerTransportType"));
        peerTransportType->setCursor(QCursor(Qt::IBeamCursor));
        peerTransportType->setTextFormat(Qt::PlainText);
        peerTransportType->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(peerTransportType, 2, 1, 1, 1);

        peerSessionIdLabel = new QLabel(detailWidget);
        peerSessionIdLabel->setObjectName(QString::fromUtf8("peerSessionIdLabel"));

        gridLayout_2->addWidget(peerSessionIdLabel, 3, 0, 1, 1);

        peerSessionId = new QLabel(detailWidget);
        peerSessionId->setObjectName(QString::fromUtf8("peerSessionId"));
        peerSessionId->setCursor(QCursor(Qt::IBeamCursor));
        peerSessionId->setTextFormat(Qt::PlainText);
        peerSessionId->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        peerNetwork->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        peerRelayTxes->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        peerHighBandwidth->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        peerLastBlock->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        peerLastTx->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        labelGeneral->setText(QCoreApplication::translate("RPCConsole", "General", nullptr));
        ...
        labelBlockChain->setText(QCoreApplication::translate("RPCConsole", "Block chain", nullptr));
...
#if QT_CONFIG(tooltip)
        peerSessionIdLabel->setToolTip(QCoreApplication::translate("RPCConsole", "The BIP324 session ID string in hex, if any.", nullptr));
#endif // QT_CONFIG(tooltip)
