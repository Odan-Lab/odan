...
struct qt_meta_stringdata_MigrateWalletActivity_t {
    QByteArrayData data[5];
    char stringdata0[58];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MigrateWalletActivity_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MigrateWalletActivity_t qt_meta_stringdata_MigrateWalletActivity = {
    {
QT_MOC_LITERAL(0, 0, 21), // "MigrateWalletActivity"
QT_MOC_LITERAL(1, 22, 8), // "migrated"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 12), // "WalletModel*"
QT_MOC_LITERAL(4, 45, 12) // "wallet_model"

    },
    "MigrateWalletActivity\0migrated\0\0"
    "WalletModel*\0wallet_model"
};
#undef QT_MOC_LITERAL
...
void MigrateWalletActivity::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->migrated((*reinterpret_cast< WalletModel*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MigrateWalletActivity::migrated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MigrateWalletActivity::staticMetaObject = { {
    QMetaObject::SuperData::link<WalletControllerActivity::staticMetaObject>(),
    qt_meta_stringdata_MigrateWalletActivity.data,
    qt_meta_data_MigrateWalletActivity,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_MigrateWalletActivity.stringdata0))
        return static_cast<void*>(this);
    return WalletControllerActivity::qt_metacast(_clname);
}
