...
QT_MOC_LITERAL(3, 41, 14), // "balanceChanged"
QT_MOC_LITERAL(4, 56, 4), // "hash"
QT_MOC_LITERAL(5, 61, 7), // "balance"
QT_MOC_LITERAL(6, 69, 11), // "updateToken"
QT_MOC_LITERAL(7, 81, 6), // "status"
QT_MOC_LITERAL(8, 88, 9) // "showToken"

    },
    "TokenItemModel\0checkTokenBalanceChanged\0"
    "\0balanceChanged\0hash\0balance\0updateToken\0"
    "status\0showToken"
};
...
static const uint qt_meta_data_TokenItemModel[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Bool,    4,    7,    8,
...
void TokenItemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TokenItemModel *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->checkTokenBalanceChanged(); break;
        case 1: _t->balanceChanged((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
...
QT_INIT_METAOBJECT const QMetaObject TokenItemModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_TokenItemModel.data,
    qt_meta_data_TokenItemModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
