#ifndef ODANDELEGATION_H
#define ODANDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
#include <uint256.h>
#include <odan/posutils.h>
...
/**
 * @brief The IOdanStaker class Delegation filter
 */
...
/**
 * @brief The OdanDelegation class Communicate with the odan delegation contract
 */
class OdanDelegation {
    
public:
    /**
     * @brief OdanDelegation Constructor
     */
    OdanDelegation();

    /**
     * @brief ~OdanDelegation Destructor
     */
    virtual ~OdanDelegation();
...
private:
    OdanDelegation(const OdanDelegation&);
    OdanDelegation& operator=(const OdanDelegation&);
    OdanDelegationPriv* priv;
};
#endif
