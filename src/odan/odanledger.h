...
/**
 * @brief The OdanLedger class Communicate with the odan ledger
 */
class OdanLedger {
    
public:
    /**
     * @brief OdanLedger Constructor
     */
    OdanLedger();

    /**
     * @brief ~OdanLedger Destructor
     */
    virtual ~OdanLedger();
...
private:
    OdanLedger(const OdanLedger&);
    OdanLedger& operator=(const OdanLedger&);
    OdanLedgerPriv* d;
};
#endif
