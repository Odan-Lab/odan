...
public:
    ...
    void setOdanTokenExec(OdanTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strOdanAddress, std::string& strHash160);
    static bool ToOdanAddress(const std::string& strHash160, std::string& strOdanAddress);
...
private:
    ...
    OdanToken(OdanToken const&);
    OdanToken& operator=(OdanToken const&);
