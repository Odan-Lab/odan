...
bool odanutils::btc_ecrecover(const dev::h256 &hash, const dev::u256 &v, const dev::h256 &r, const dev::h256 &s, dev::h256 &key)
{
...
int odanutils::eth_getChainId(int blockHeight, int shanghaiHeight, const ChainType& chain)
{
...
int odanutils::eth_getChainId(int blockHeight)
{
