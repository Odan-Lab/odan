...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, convert_btc_bech32_address_to_odan("bcrt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th68x4f8g"))
        ...
        assert_equal(address2, convert_btc_address_to_odan("2N2gQKzjUe47gM8p1JZxaAkTcoHPXV6YyVp"))
        ...
        assert_equal(address3, convert_btc_address_to_odan("n1LKejAadN6hg2FrBXoU1KrwX4uK16mco9"))
        ...
        assert_equal(address4, convert_btc_bech32_address_to_odan("bcrt1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62ms4e9sqj", encoding=Encoding.BECH32M))
