...
from test_framework.odanconfig import INITIAL_BLOCK_REWARD
...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-8, "Cannot specify both fee_rate (sat/vB) and feeRate (ODAN/kvB)",
        ...
        for creator in creators:
            ...
            for k in creator['outputs']:
                new_key = convert_btc_bech32_address_to_odan(list(k.keys())[0])
