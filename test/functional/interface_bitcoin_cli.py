...
from test_framework.odanconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_specified_wallet_compiled():
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (ODAN/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (ODAN/kvB)']), network_info['relayfee'])
