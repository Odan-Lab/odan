...
from test_framework.odanconfig import COINBASE_MATURITY, INITIAL_BLOCK_REWARD
...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        common_address = convert_btc_address_to_odan("msf4WtN1YQKXvNtvdFYt9JBnUD2FB41kjr")
        node.sendmany(
        ...
        if self.options.descriptors:
            ...
            BECH32_VALID = {
                '✔️_VER15_PROG40': convert_btc_bech32_address_to_odan('bcrt10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqxkg7fn'),
                '✔️_VER16_PROG03': convert_btc_bech32_address_to_odan('bcrt1sqqqqq8uhdgr'),
                '✔️_VER16_PROB02': convert_btc_bech32_address_to_odan('bcrt1sqqqq4wstyw'),
            }
            BECH32_INVALID = {
                '❌_VER15_PROG41': convert_btc_bech32_address_to_odan('bcrt1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqajlxj8'),
                '❌_VER16_PROB01': convert_btc_bech32_address_to_odan('bcrt1sqq5r4036'),
            }
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Odan address or script",
