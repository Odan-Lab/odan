...
from test_framework.odan import convert_btc_address_to_odan, generatesynchronized, convert_btc_bech32_address_to_odan
...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            assert_raises_rpc_error(-5, "Invalid Odan address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Bitcoin address
            assert_raises_rpc_error(-5, "Invalid Odan address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Odan address or script", self.nodes[0].importaddress, "invalid")
            ...
            assert_raises_rpc_error(-5, "Bech32m addresses cannot be imported into legacy wallets", self.nodes[0].importaddress, convert_btc_bech32_address_to_odan("bcrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqc8gma6"))
        ...
        address_info = self.nodes[0].getaddressinfo(convert_btc_address_to_odan("mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ"))
        assert_equal(address_info['address'], convert_btc_address_to_odan("mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ"))
