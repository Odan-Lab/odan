...
from test_framework.odan import generatesynchronized, convert_btc_bech32_address_to_odan 
...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        non_hd_add = convert_btc_bech32_address_to_odan('bcrt1qmevj8zfx0wdvp05cqwkmr6mxkfx60yezwjksmt')
