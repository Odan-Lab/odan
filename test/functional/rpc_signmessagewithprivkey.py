...
class SignMessagesWithPrivTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(addresses[0], convert_btc_address_to_odan('mpLQjfK79b7CCV4VMJWEWAj5Mpx8Up5zxB'))
        ...
        assert_raises_rpc_error(-3, "Malformed base64 encoding", self.nodes[0].verifymessage, convert_btc_address_to_odan('mpLQjfK79b7CCV4VMJWEWAj5Mpx8Up5zxB'), "invalid_sig", message)
