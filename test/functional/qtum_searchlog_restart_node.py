...
from test_framework.odan import generatesynchronized
from test_framework.odanconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class OdanRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    OdanRPCSearchlogsTestModified().main()
