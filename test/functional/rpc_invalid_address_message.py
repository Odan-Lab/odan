...
BECH32_VALID = convert_btc_bech32_address_to_odan('bcrt1qtmp74ayg7p24uslctssvjm06q5phz4yrxucgnv')
BECH32_VALID_CAPITALS = convert_btc_bech32_address_to_odan('BCRT1QPLMTZKC2XHARPPZDLNPAQL78RSHJ68U33RAH7R')
BECH32_VALID_MULTISIG = convert_btc_bech32_address_to_odan('bcrt1qdg3myrgvzw7ml9q0ejxhlkyxm7vl9r56yzkfgvzclrf4hkpx9yfqhpsuks')

BECH32_INVALID_BECH32 = convert_btc_bech32_address_to_odan('bcrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqdmchcc')
BECH32_INVALID_BECH32M = convert_btc_bech32_address_to_odan('bcrt1qw508d6qejxtdg4y5r3zarvary0c5xw7k35mrzd')
BECH32_INVALID_VERSION = convert_btc_bech32_address_to_odan('bcrt130xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqynjegk')
BECH32_INVALID_SIZE = convert_btc_bech32_address_to_odan('bcrt1s0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7v8n0nx0muaewav25430mtr')
BECH32_INVALID_V0_SIZE = convert_btc_bech32_address_to_odan('bcrt1qw508d6qejxtdg4y5r3zarvary0c5xw7kqqq5k3my')
...
class InvalidAddressErrorMessageTest(BitcoinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(-1, "Return information about the given odan address.", node.validateaddress)
